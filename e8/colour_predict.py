...
def main():
    ...
    knn_convert_model = make_pipeline(FunctionTransformer(rgb2lab), KNeighborsClassifier(n_neighbors=5))
    ...
    rf_convert_model = make_pipeline(FunctionTransformer(rgb2lab), RandomForestClassifier(n_estimators=100))
